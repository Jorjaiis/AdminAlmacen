...
{
    public class ProviderAuthentication : MembershipProvider
    {
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            using (AlmacenDBEntities db = new AlmacenDBEntities())
            {
                ...
                return user == null ? null : new UserMembership(user);
            }
        }
        ...
        public override bool ValidateUser(string username, string password)
        {
            using (AlmacenDBEntities db = new AlmacenDBEntities())
            {
                ...
                return db.user.Any(x => x.password == pass && x.email == username);
            }
